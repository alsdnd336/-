...
character = pygame.image.load("C:\\coding\\mygame\\ball_images\\character.png")
...
monster_images = [
    pygame.image.load("C:\\coding\\mygame\\ball_images\\monster1.png"),
    pygame.image.load("C:\\coding\\mygame\\ball_images\\monster2.png"),
    pygame.image.load("C:\\coding\\mygame\\ball_images\\monster3.png")]
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if keyboard.is_pressed("space") and jump_condition == True:
                jump_condition = False
                character_to_y -= character_jump * dt
    ...
    if character_pos_y <= screen_height/2 + character_height:
        character_to_y = 0.075
    ...
    if elapsed_time == 10 and monster_added  == False: # 5초라는 시간동안 한번만 입력해주는 변수
    ...
    if elapsed_time == 20 and monster_added == True: # 해당 조건에 monster_added를 쓰면 오류가 뜸
